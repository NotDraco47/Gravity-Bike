...
- Fork the repository for personal, non-commercial experimentation.
- Share the official repository link without modification.
...
- Include a visible reference to the official repository.
- Avoid using official branding, logos, or identity without authorization.

The creator reserves the right to request removal of any derivative work
that violates the integrity or intended purpose of the project.

5. COMMERCIAL LICENSING

Commercial use of any part of this project requires direct written permission
from the creator. For licensing inquiries, contact:

notdraco23@gmail.com
...
The creator shall not be liable for any damages arising from the use of this project.
